...
class BorderGlow {
    ...
    init() {
        ...
        // Setup inner structure
        const innerContent = this.card.innerHTML;
        this.card.innerHTML = `
    ...
    applyStyles() {
        const glowVars = buildGlowVars(this.options.glowColor, this.options.glowIntensity);
        const gradientVars = buildGradientVars(this.options.colors);
        ...
        for (const [key, value] of Object.entries(styles)) {
            this.card.style.setProperty(key, value);
        }
    }
